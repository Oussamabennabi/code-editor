...
const Landing = () => {
  ...
  return (
    <>
      ...
      <div className="flex md:mt-4 mt-20 flex-row">
      ...
      >
        <Split
          className={` 
          split w-full  flex ${
            windowSize < windowBreakPoint
              ? "flex-col  h-[125vh]"
              : "flex-row  h-[85vh]"
          }`}
          snapOffset={10}
          minSize={windowSize < 1000 ? 300 : 400}
          sizes={[75, 25]}
          gutterSize={15}
        ...
        >
          ...
          <div className="flex  px-2 right-container  flex-col">
            ...
            <div className=" w-full h-full flex flex-col items-end">
              ...
              <button
                ...
                className={classnames(
                  "disabled:cursor-not-allowed mt-4 mb-20 border-2 border-black z-10 rounded-md shadow-[5px_5px_0px_0px_rgba(0,0,0)] px-4 py-2 hover:shadow transition duration-200 bg-white flex-shrink-0",
                  !code ? "opacity-50" : ""
                )}
              >
                {processing ? "Sbar shwiya..." : "Compile and Execute"}
              </button>
            </div>
